...
import com.nhnacademy.springmvcboard.utils.LoginCounterUtils;
...
public class LoginController implements BaseController{
    ...
    public String doLogin(Model model, @Valid LoginRequest loginRequest, BindingResult bindingResult, HttpServletRequest request, HttpServletResponse response,RedirectAttributes redirectAttributes){
        ...
        if(loginServlce.match(adminUser, loginRequest)) {
            ...
            long siteVisitCount =  LoginCounterUtils.increaseCounter(request.getServletContext());
            model.addAttribute("siteVisitCount", siteVisitCount);
            log.info("siteVisitCount<><><><>: {}", siteVisitCount);
            ...
            for(User user : userList) {
                if(loginServlce.match(user, loginRequest)) {
                    ...
                    LoginCounterUtils.increaseCounter(request.getServletContext());
