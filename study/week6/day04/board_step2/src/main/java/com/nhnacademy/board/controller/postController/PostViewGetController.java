...
public class PostViewGetController implements Command {
    ...
    public String execute(HttpServletRequest req, HttpServletResponse resp) {
        ...
        postRepository.modify(new ConcretePost(post.getId(), post.getTitle(), post.getContent(), post.getWriterUserId(), post.getViewCount()));
        log.error("viewCount:{}", post.getViewCount());
