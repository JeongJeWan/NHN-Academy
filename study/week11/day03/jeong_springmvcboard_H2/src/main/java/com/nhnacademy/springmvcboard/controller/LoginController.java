...
import com.nhnacademy.springmvcboard.Service.impl.LoginServlce;
import com.nhnacademy.springmvcboard.Service.impl.DbUserServiceImpl;
...
public class LoginController implements BaseController{
    ...
    public LoginController(UserEventService userEventService, LoginServlce loginServlce, User adminUser) {
    ...
    public String doLogin(Model model, @Valid LoginRequest loginRequest, BindingResult bindingResult, HttpServletRequest request, HttpServletResponse response,RedirectAttributes redirectAttributes){
        ...
        log.info("DbUserRepositort: {}", userEventService.getUsers());
