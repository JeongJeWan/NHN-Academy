...
public class ServletContextListener implements javax.servlet.ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        ...
        if(target.exists()){
            try (
                ...
                servletContext.setAttribute("currentCounter",c);
        ...
        log.error("init counter : {}", servletContext.getAttribute("currentCounter"));
    }
    ...
    public void contextDestroyed(ServletContextEvent sce) {
        ...
        try(
            ...
            fw.write( String.valueOf(servletContext.getAttribute("currentCounter")));
        } catch (IOException e) {
            e.printStackTrace();
        }

        System.out.println("distory-currentCounter:" + servletContext.getAttribute("currentCounter"));
